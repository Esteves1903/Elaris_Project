  ...
  const menuCategories = [
    {
      name: t.cat1,
      items: [
        { n: t.n_wagyu,      p: "AED 245", d: t.d_wagyu,      img: "/A5Wagyu.webp" },
        { n: t.n_lobster,    p: "AED 190", d: t.d_lobster,    img: "/LagostaAzul.webp" },
        { n: t.n_caviar,     p: "AED 850", d: t.d_caviar,     img: "/caviar.webp" },
        { n: t.n_foie,       p: "AED 210", d: t.d_foie,       img: "/FoieGras.webp" },
      ],
    },
    {
      name: t.cat2,
      items: [
        { n: t.n_francesinha, p: "AED 320", d: t.d_francesinha, img: "/francesinha.webp" },
        { n: t.n_seabass,     p: "AED 450", d: t.d_seabass,     img: "/seabass.webp" },
        { n: t.n_octopus,     p: "AED 280", d: t.d_octopus,     img: "/octopus.webp" },
        { n: t.n_lamb,        p: "AED 390", d: t.d_lamb,        img: "/lambchops.webp" },
        { n: t.n_truffle,     p: "AED 310", d: t.d_truffle,     img: "/truffleRisotto.webp" },
      ],
    },
    {
      name: t.cat3,
      items: [
        { n: t.n_abade,     p: "AED 110", d: t.d_abade,     img: "/abade.webp" },
        { n: t.n_chocolate, p: "AED 135", d: t.d_chocolate, img: "/chocolate.webp" },
      ],
    },
  ];
