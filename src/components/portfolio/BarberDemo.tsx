...
export function BarberDemo() {
  ...
  const tBarber = {
    ...
    pt: {
      ...
      premiumServices: "Serviços Premium", theExperience: "A ExperiÃªncia",
      ...
      testimonial1: "A melhor experiÃªncia de barbearia que já tive. Nível absolutamente internacional.",
  ...
  const services: BarberService[] = [
    ...
    },
    {
      ...
      desc: lang === "en"
        ...
        : "ExperiÃªncia total: corte, barba, tratamento facial masculino, scalp massage e styling com produtos de luxo. O standard máximo.",
    },
    {
