...
export function FootballStoreDemo() {
  ...
  const t = {
    ...
    pt: {
      ...
      noProducts: "Nenhum produto encontrado para", backToShop: "Voltar Ã  Loja", reviews: "avaliações",
      ...
      prod5_d: "Luvas de guarda-redes profissionais com palma de látex NC Excellent 3mm. AderÃªncia excecional em todas as condições climatéricas.",
      prod6_d: "O equipamento alternativo da França 2024 com um deslumbrante degradÃª azul-marinho. Tecnologia oficial Dri-FIT ADV para desempenho máximo.",
